...
import com.creditease.checkcars.net.oper.bean.OrderFinishBean;
 ...
 * @company 宜信
 */
public final class CarOrderFinishOperation extends Oper< Object >
{
    public CarOrderFinishOperation(Context mContext, RequestListener listener)
    {
    ...
    {
        return Config.WS_USERS_CARORDER_FINISH_URL;
    }
     ...
     */
    public void setParam(String orderId, int status, String orderEndTime)
    {

        String json =
                JsonUtils.requestObjectBean(new OrderFinishBean.RequestObj(orderId, status, orderEndTime));
