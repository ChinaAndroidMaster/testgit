 ...
 * @company CREDITEASE
 */
public class FragmentAllcover extends BaseFragment implements IWebViewListener
{
    public static final String TAG = FragmentAllcover.class.getSimpleName();
    ...
    {
        return R.layout.fragment_allcover;
    }

    @Override
    protected void initView(View view)
    {
        webView = ( CEWebView ) view.findViewById(R.id.fragment_allcover_webview);
    }
    ...
    protected void initData()
    {
        // 初始化webview并加载网页
        time = 0;
        String salerId = SharePrefenceManager.getSalerId(getContext());
        webView.init(getContext(), Config.ALLCOVER_HOME_URL + salerId);
    ...
    public boolean overrideUrlLoading(WebView view, String url)
    {
        ...
        } else
        {
            ...
            intent.putExtra(WebViewActivity.PARAM_TITLE, "质保销售");
