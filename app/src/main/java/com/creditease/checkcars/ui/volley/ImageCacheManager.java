...
public class ImageCacheManager
{
    ...
    public DiskLruImageCache getDiskLruImageCache()
    {
        ...
        {
            return ( DiskLruImageCache ) mImageCache;
        }
        return null;
    }

    public BitmapLruImageCache getBitmapLruImageCache()
    {
        if ( mImageCache instanceof BitmapLruImageCache )
        {
            return ( BitmapLruImageCache ) mImageCache;
        }
        return null;
    }
