...
public class XListView extends ListView implements OnScrollListener
{
            ...
            default:
                ...
                if ( getFirstVisiblePosition() == 0 )
                {
                    ...
                    if ( mEnablePullRefresh && (mHeaderView.getVisiableHeight() > mHeaderViewHeight) )
                    {
                        ...
                        // Holding the headerview of height 70dp and starting request data
                        // mHeaderView.setVisiableHeight(Util.dip2px(context, 70));
                    }
                    resetHeaderHeight();
                }
    ...
    public void stopRefresh()
    {
        if ( mPullRefreshing == true )
        {
            ...
            resetHeaderHeight();
            // clear animation,thrift memory
            mHeaderView.mLoadingLayout.clearAnimation();
        }
    }
