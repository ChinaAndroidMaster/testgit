...
package com.creditease.utilframe.db.table;
...
import com.creditease.utilframe.db.annotation.Check;
import com.creditease.utilframe.db.annotation.Column;
import com.creditease.utilframe.db.annotation.Finder;
import com.creditease.utilframe.db.annotation.Foreign;
import com.creditease.utilframe.db.annotation.Id;
import com.creditease.utilframe.db.annotation.NotNull;
import com.creditease.utilframe.db.annotation.Transient;
import com.creditease.utilframe.db.annotation.Unique;
import com.creditease.utilframe.db.converter.ColumnConverter;
import com.creditease.utilframe.db.converter.ColumnConverterFactory;
import com.creditease.utilframe.db.sqlite.FinderLazyLoader;
import com.creditease.utilframe.db.sqlite.ForeignLazyLoader;
import com.creditease.utilframe.util.LogUtils;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.creditease.utilframe.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.creditease.utilframe.db.table.Finder finderColumn) {
