...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.creditease.utilframe.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.creditease.utilframe.db.table.Id>();

    /* package */
    static synchronized com.creditease.utilframe.db.table.Id getId(Class<?> entityType) {
        ...
        com.creditease.utilframe.db.table.Id id = new com.creditease.utilframe.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.creditease.utilframe.db.table.Id id = getId(entityType);
