...
package com.creditease.utilframe.http.client.util;
...
public class URLEncodedUtils {
     ...
     * @return encoded string
     */
    protected static String decodeFormFields(final String content, final String charset) {
        if (content == null) {
            return null;
        }
     ...
     * @return encoded string
     */
    protected static String decodeFormFields(final String content, final Charset charset) {
        if (content == null) {
            return null;
        }
